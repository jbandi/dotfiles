...
def get_list_dir(start_path):
    ...
    for item in os.listdir(start_path):
        curr_path = os.path.join(start_path, item)
...
#    print("-----")
#    print("--"+ "Cur. branch: " + repr(active_branch) )
#    if cur_tag is not None:
#        print("--"+ "Cur. tag: " + repr(cur_tag.name) )
